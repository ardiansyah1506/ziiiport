    ...
    <>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter relative">
          ...
          <motion.article variants={fadeUp} className="col-span-1 md:col-span-12 group relative border border-outline-variant bg-surface-container-lowest hover:border-[#00ff41] transition-colors">
              ...
              <div className="w-full md:w-5/12 p-margin-safe flex flex-col justify-between">
                <div>
                  <div className="flex flex-wrap gap-stack-sm mb-stack-md">
                    <span className="font-metadata text-metadata text-[#00ff41] border border-[#00ff41] px-2 py-1 uppercase">[SaaS]</span>
                    <span className="font-metadata text-metadata text-on-surface-variant border border-outline-variant px-2 py-1 uppercase">[Next.js]</span>
                    <span className="font-metadata text-metadata text-on-surface-variant border border-outline-variant px-2 py-1 uppercase">[PostgreSQL]</span>
                  </div>
                  <h3 className="font-headline-md text-headline-md text-on-surface mb-stack-sm group-hover:text-[#00ff41] transition-colors">Nexus Analytics Platform</h3>
                  <p className="font-body text-body text-on-surface-variant mb-stack-md">
                    An enterprise-grade analytics dashboard processing millions of events daily. Built with a focus on high-performance data visualization and real-time reporting for marketing teams.
                  </p>
                </div>
                <div className="flex justify-between items-end border-t border-outline-variant pt-stack-md mt-stack-md">
                  <span className="font-metadata text-metadata text-on-surface-variant">TIMESTAMP: 2023.11</span>
                  <Link href="/projects" className="w-10 h-10 border border-outline-variant flex items-center justify-center text-on-surface-variant hover:bg-[#00ff41] hover:text-[#121415] hover:border-[#00ff41] transition-all">
          ...
          <motion.article variants={fadeUp} className="col-span-1 md:col-span-6 group relative border border-outline-variant bg-surface-container-lowest hover:border-[#00ff41] transition-colors flex flex-col">
            ...
            <div className="p-margin-safe flex flex-col flex-grow justify-between">
              <div>
                <div className="flex flex-wrap gap-stack-sm mb-stack-md">
                  <span className="font-metadata text-metadata text-[#00ff41] border border-[#00ff41] px-2 py-1 uppercase">[CLI Tool]</span>
                  <span className="font-metadata text-metadata text-on-surface-variant border border-outline-variant px-2 py-1 uppercase">[Go]</span>
                </div>
                <h3 className="font-headline-md text-headline-md text-on-surface mb-stack-sm group-hover:text-[#00ff41] transition-colors">Orbit Deploy</h3>
                <p className="font-body text-body text-on-surface-variant mb-stack-md line-clamp-3">
                  A blazingly fast deployment CLI for static sites. Automates CI/CD pipelines directly from the terminal with sub-second execution times and distributed caching.
                </p>
              </div>
              <div className="flex justify-between items-end border-t border-outline-variant pt-stack-md mt-stack-md">
                <span className="font-metadata text-metadata text-on-surface-variant">TIMESTAMP: 2023.08</span>
                <Link href="/projects" className="w-10 h-10 border border-outline-variant flex items-center justify-center text-on-surface-variant hover:bg-[#00ff41] hover:text-[#121415] hover:border-[#00ff41] transition-all">
                  <span className="material-symbols-outlined">arrow_outward</span>
                </Link>
              </div>
          ...
          <motion.article variants={fadeUp} className="col-span-1 md:col-span-6 group relative border border-outline-variant bg-surface-container-lowest hover:border-[#00ff41] transition-colors flex flex-col">
            <div className="w-full relative overflow-hidden border-b border-outline-variant p-unit aspect-video">
              <div className="w-full h-full bg-surface-container relative">
                <img 
                  alt="Cognitive Agent UI interface" 
                  className="absolute inset-0 w-full h-full object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-700 group-hover:scale-105" 
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuC19snssACECLRhl5_1JLfR39_BGpphzitvwxAGT6g_WLFbSloaKLpDSWBroDInnwF1h05HmsoxZqycEU587PZjW1L7IMGIh3MYdIJ-V47aBlmAzNhkzXjM2x5svB533Ddmk0e65hj3Fo9VbtYN33X1FXcRhEOT4gelONJZn--xhDQ0gGfsQLx60q6FL8YEKFVAKjEdBG4sxCJZ-goJyY403rWxxQ3D2iGSoBIDIH7OXfd4DRXHuPNBbA" 
                />
              </div>
            </div>
            <div className="p-margin-safe flex flex-col flex-grow justify-between">
              <div>
                <div className="flex flex-wrap gap-stack-sm mb-stack-md">
                  <span className="font-metadata text-metadata text-[#00ff41] border border-[#00ff41] px-2 py-1 uppercase">[AI / LLM]</span>
                  <span className="font-metadata text-metadata text-on-surface-variant border border-outline-variant px-2 py-1 uppercase">[Python]</span>
                  <span className="font-metadata text-metadata text-on-surface-variant border border-outline-variant px-2 py-1 uppercase">[React]</span>
                </div>
                <h3 className="font-headline-md text-headline-md text-on-surface mb-stack-sm group-hover:text-[#00ff41] transition-colors">Cognitive Agent UI</h3>
                <p className="font-body text-body text-on-surface-variant mb-stack-md line-clamp-3">
                  A specialized interface for orchestrating multi-agent AI systems. Allows users to visualize reasoning chains and manage context windows across disparate tasks in real-time.
                </p>
              </div>
              <div className="flex justify-between items-end border-t border-outline-variant pt-stack-md mt-stack-md">
                <span className="font-metadata text-metadata text-on-surface-variant">TIMESTAMP: 2024.01</span>
                <Link href="/projects" className="w-10 h-10 border border-outline-variant flex items-center justify-center text-on-surface-variant hover:bg-[#00ff41] hover:text-[#121415] hover:border-[#00ff41] transition-all">
                  <span className="material-symbols-outlined">arrow_outward</span>
                </Link>
              </div>
